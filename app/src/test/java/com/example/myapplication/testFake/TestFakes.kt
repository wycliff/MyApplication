package com.example.myapplication.testFake

import com.example.myapplication.model.dataSource.network.data.response.City
import com.example.myapplication.model.dataSource.network.data.response.Coord
...
import com.example.myapplication.model.dataSource.network.data.response.Main
